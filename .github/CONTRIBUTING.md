...
I truly appreciate all the contributions from the community, whether it's proposing features, identifying bugs, or fixing mistakes! To ensure
...
[by submitting a pull request](https://github.com/djoezeke/mytoml/edit/main/.github/CONTRIBUTING.md).
...
Please [create an issue](https://github.com/djoezeke/mytoml/issues/new/choose), assuming one does not already exist, and
...
[bug report](https://github.com/djoezeke/mytoml/blob/main/.github/ISSUE_TEMPLATE/bug.yaml) if possible.

### Reporting a security vulnerability

You can report a security vulnerability according to our
[security policy](https://github.com/djoezeke/mytoml/security/policy).

### Discussing a new feature

For questions, feature or support requests, please
[open a discussion](https://github.com/djoezeke/mytoml/discussions/new). If you find a proposed answer satisfactory,
...
Create a [pull request](https://github.com/djoezeke/mytoml/pulls?q=sort%3Aupdated-desc+is%3Apr+is%3Aopen) against the
`main` branch and follow the pull request template. In particular,
...
- The library’s [README file](https://github.com/djoezeke/mytoml/blob/main/README.md) is an excellent starting point to
  understand its functionality.
- The [documentation page](https://djoezeke.github.io/mytoml) is the reference documentation of the library.
